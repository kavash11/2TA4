...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
  ...
  if(GPIO_Pin == KEY_BUTTON_PIN)  //GPIO_PIN_0
  {
		...
		TIM3_CCR2_Val=TIM3_CCR2_Val/2;
		TIM3_CCR3_Val=TIM3_CCR3_Val/2;
		TIM3_CCR4_Val=TIM3_CCR4_Val/2;
		...
		__HAL_TIM_SET_COMPARE(&Tim3_Handle, TIM_CHANNEL_3,TIM3_CCR3_Val);
		__HAL_TIM_SET_COMPARE(&Tim3_Handle, TIM_CHANNEL_4,TIM3_CCR4_Val);
